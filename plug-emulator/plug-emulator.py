...
def send_wattage(plug, wattage):
	data = bytearray(b"L00TWlIt00000000000000P00000000500000C01D00X")
	copy_size(44, data)
	copy_count(1, data)
	copy_watt(wattage, data)
	curr_time = int((time.time() * 10000) - start)
	copy_time(curr_time * 10, data, 21)
	print data
	try:
		num = plug.send(data)
		#print num
...
def send_temperature(plug, temperature):
	data = bytearray(b"L00TTlIt00000000000000P00000000500000C01D00X")
	copy_size(44, data)
	copy_count(1, data)
...
def send_voltage(plug):
	curr_time = int((time.time() * 10000) - start)
	for t in range(0, 1):
		data = bytearray(b"")
		copy_size(442, data)
		copy_count(200, data)
		for i in range(1, 201):
			copy_data(volt_wave((curr_time / 10000.0) + (i / 2400.0)), i * 2 + 39, data)
		copy_time(int(curr_time * 10), data, 21)
...
def send_current(plug):
	...
	for t in range(0, 1):
		...
		data = bytearray(b"")
		copy_size(442, data)
		copy_count(200, data)
		for i in range(1, 201):
